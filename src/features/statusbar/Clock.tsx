...
export function Clock() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 rounded-md px-1.5 py-1 text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200"
    >
